...
from mol.vm_genesis.lib import encode_genesis_transaction_with_validator_and_modules, make_placeholder_discovery_set, GENESIS_KEYPAIR
...
def rust_validator_set() -> List[ValidatorPublicKeys]:
    return [
        ValidatorPublicKeys(
            account_address = bytes.fromhex("5181c01f6005d3236cb950f21a83c22489b9f9d1fadc027cf9532d6f99041522")[:16],
        ...
        ValidatorPublicKeys(
            account_address = bytes.fromhex("5c7bdc35ea7d5e5650f74e06812e3470963d39c834aa39d02bcf85103bd49e1d")[:16],
        ...
        ValidatorPublicKeys(
            account_address = bytes.fromhex("6689850ab011894daf9ff189e372edce2f5c0957a2c951cd055772e5d8d0b202")[:16],
        ...
        ValidatorPublicKeys(
            account_address = bytes.fromhex("693124105a409f104267a364427f45929b6d2924fb332700c2bc1372f71d1657")[:16],
        ...
        ValidatorPublicKeys(
            account_address = bytes.fromhex("6a76d034e3c89733834cbbe2be9b7e4c3a97274bc887b1d1786450ac8469ea44")[:16],
        ...
        ValidatorPublicKeys(
            account_address = bytes.fromhex("78b108fa9667712c761d70c1e526be8901cad453fcc40c359ce850fd9efb1b50")[:16],
        ...
        ValidatorPublicKeys(
            account_address = bytes.fromhex("826b443135b47a8bfdf090f0088a427aeae1de70c6cf833823715c07539bcc3a")[:16],
        ...
        ValidatorPublicKeys(
            account_address = bytes.fromhex("95efd320a03cfab116191ccf04c8a8f6f54120cebf0047fc06923a39673ebbb8")[:16],
        ...
        ValidatorPublicKeys(
            account_address = bytes.fromhex("a02afc51b04befbf77c3a33d5bcba016401bad8eef79939fde82f6a29adf3e27")[:16],
        ...
        ValidatorPublicKeys(
            account_address = bytes.fromhex("ac9571d0894723b7e0664a338707972b03978f662c92b6ec005a4d758cbfdd1d")[:16],
...
def diff_tx(old_tx, tx):
    ...
    for idx, (ow, ew) in enumerate(zip(old_cs.write_set.write_set, cs.write_set.write_set)):
        ...
        #     assert oar == ear
        # if idx == 21:
        #     from mol.vm.gas_schedule import CostTable
        #     from mol.vm_genesis.genesis_gas_schedule import init_cost_table
