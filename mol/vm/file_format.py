...
from mol.vm.file_format_common import Opcodes, SerializedType, BinaryData, SerializedNativeStructFlag
...
class SignatureToken:
    ...
    def check_struct_handles(self, struct_handles: List[StructHandle]) -> List[VMStatus]:
        if self.tag == SerializedType.STRUCT:
            from mol.vm.check_bounds import check_bounds_impl
...
class CompiledScriptMut:
    ...
    def serialize(self) -> bytes:
        ...
        from mol.vm.serializer import ScriptSerializer
    ...
    def deserialize_no_check_bounds(cls, binary: bytes) -> CompiledScriptMut:
        from mol.vm.deserializer import deserialize_compiled_script
...
class CompiledModuleMut:
    ...
    def deserialize_no_check_bounds(cls, binary: bytes) -> CompiledModuleMut:
        from mol.vm.deserializer import deserialize_compiled_module
