...
from mol.vm.file_format import Bytecode, CompiledModule, StructFieldInformation, ModuleAccess
from mol.vm import IndexKind, Opcodes, SerializedNativeStructFlag
