...
𝛕 ∈ Type .=
  ...
  | t # mutable reference to a base type
...
addr ∈ Address # addresses of blockchain accounts
...
r ∈ ReferenceOp .=
  ...
  | &e.f      # type: '&t_1 -> &t_2' or 't_1 -> t_2'
              # borrows a new reference to field 'f' of the class 't_1'. inherits exclusive or shared from parent
              # 't_1' must be a class declared in the current module, i.e. 'f' is "private"
  | *e        # type: '&t -> t' or 't -> t'. Dereferencing. Not valid for resources
...
mop ∈ ModuleOp .=
  | move_to_sender<n>(e) # type: 'Self.n -> unit'
                         # publishes resource class 'n' under sender's address
                         # fails if there is already a resource present for 'Self.n'
  | move_from<n>(e)      # type: 'address -> Self.n'
                         # removes the resource class 'n' at the specified address
                         # fails if there is no resource present for 'Self.n'
  | borrow_global<n>(e)  # type: 'address -> Self.n'
                         # borrows a mutable reference to the resource class 'n' at the specified address
...
c ∈ Cmd .=
  ...
  | *x = e                              # mutation, s.t. 'x: t' and 'e: t' and 't' is not of resource kind
  | assert(e_1, e_2)                    # type: 'bool * Uint64 -> unit'
  ...
  | n { f_1: x_1, ... , f_j: x_j } = e  # "de-constructor" for 'n'
                                        # "unpacks" a class value 'e: _#Self.n'
...
sdecl ∈ StructDecl .=
  ...
  | class n { f_1: t_1, ..., f_j: t_j }   # declaration of a non-resource (value) struct
                                           # s.t. any 't_i' is not of resource kind

body ∈ ProcedureBody .=
 | x_1; ... x_j; s # The locals declared in this procedure, and the code for that procedure
