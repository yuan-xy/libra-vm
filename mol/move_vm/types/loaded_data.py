...
class Type(RustEnum):  # order not same with SerializedType
    _enums = [
        ...
        ('U128', None),
        ('Address', None),
        ('Vector', 'mol.move_vm.types.loaded_data.Type'),
        ('Struct', 'mol.move_vm.types.loaded_data.StructDef'),
        ('Reference', 'mol.move_vm.types.loaded_data.Type'),
        ('MutableReference', 'mol.move_vm.types.loaded_data.Type'),
        ('TypeVariable', Uint16)
    ]
...
class StructDef(RustEnum):
    _enums = [
        ...
        ('Native', 'mol.move_vm.types.native_structs.NativeStructType')
    ]
