...
from mol.move_vm.types.ref_cell import RefCell, Ref, RefMut, RefCellCanoser
from mol.move_vm.types.native_functions import native_gas, NativeResult, NativeFunction
...
from mol.vm.file_format import SignatureToken
...
from mol.vm.signature_token_help import VectorU8
...
class ValueImpl(RustEnum):
    _enums = [
        ...
        ('ContainerRef', 'mol.move_vm.types.values.ContainerRef'),
        ('IndexedRef', 'mol.move_vm.types.values.IndexedRef')
    ]
...
class ContainerRef(RustEnum):
    _enums = [
        ...
        ('Global', 'mol.move_vm.types.values.GlobalValue')
    ]
