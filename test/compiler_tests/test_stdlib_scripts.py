...
from mol.compiler.ir_to_bytecode.parser import parse_module
...
def test_compile_native_hash():
    code = include_str("../../mol/compiler/ir_stdlib/modules/hash.mvir")
    _compiled_module = compile_module_string(code)


def test_compile_u64_util():
    code = include_str("../../mol/compiler/ir_stdlib/modules/u64_util.mvir")
    _compiled_module = compile_module_string(code)
...
def test_compile_libra_coin():
    code = include_str("../../mol/compiler/ir_stdlib/modules/libra_coin.mvir")
    _compiled_module = compile_module_string(code)


def test_parse_libra_coin():
    code = include_str("../../mol/compiler/ir_stdlib/modules/libra_account.mvir")
...
def test_compile_account_module():
    vector_code = include_str("../../mol/compiler/ir_stdlib/modules/vector.mvir")
    address_util_code = include_str("../../mol/compiler/ir_stdlib/modules/address_util.mvir")
    Uint64_util_code = include_str("../../mol/compiler/ir_stdlib/modules/u64_util.mvir")

    hash_code = include_str("../../mol/compiler/ir_stdlib/modules/hash.mvir")
    coin_code = include_str("../../mol/compiler/ir_stdlib/modules/libra_coin.mvir")
    time_code = include_str("../../mol/compiler/ir_stdlib/modules/libra_time.mvir")
    ttl_code = include_str("../../mol/compiler/ir_stdlib/modules/libra_transaction_timeout.mvir")
    account_code = include_str("../../mol/compiler/ir_stdlib/modules/libra_account.mvir")
...
def test_compile_create_account_script():
    code = include_str("../../mol/compiler/ir_stdlib/transaction_scripts/create_account.mvir")
    # _compiled_script = compile_script_string_with_stdlib(code)



def test_compile_mint_script():
    code = include_str("../../mol/compiler/ir_stdlib/transaction_scripts/mint.mvir")
    # _compiled_script = compile_script_string_with_stdlib(code)



def test_compile_rotate_authentication_key_script():
    code = include_str("../../mol/compiler/ir_stdlib/transaction_scripts/rotate_authentication_key.mvir")
    _compiled_script = compile_script_string_with_stdlib(code)



def test_compile_peer_to_peer_transfer_script():
    code = include_str("../../mol/compiler/ir_stdlib/transaction_scripts/peer_to_peer_transfer.mvir")
    try:
        _compiled_script = compile_script_string_with_stdlib(code)
